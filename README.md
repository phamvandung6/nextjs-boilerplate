...
🚀 Boilerplate and Starter for Next.js with App Router, Tailwind CSS, and TypeScript ⚡️ Prioritizing developer experience: Next.js, TypeScript, ESLint/Prettier, Lefthook, Knip, Vitest, i18n, SEO defaults, Sentry, Arcjet, LogTape, Semantic Release, and more—trimmed for backend-driven apps (auth/DB left to you).
...
Developer experience first, trimmed for a personal SEO-friendly starter:
...
- 🦊 Git hooks with Lefthook, Commitlint, Knip
- 🦺 Testing with Vitest
- 🚨 Error Monitoring with [Sentry](https://sentry.io/for/nextjs/?utm_source=github&utm_medium=paid-community&utm_campaign=general-fy25q1-nextjs&utm_content=github-banner-nextjsboilerplate-logo)
- 📝 Logging with LogTape (+ Better Stack ready)
- 🔐 Security/bot protection with [Arcjet](https://launch.arcjet.com/Q6eLbRE)
- 🎁 Semantic Release, bundle analyzer, SEO metadata/OG/JSON-LD, sitemap/robots
- 💡 Absolute imports using `@` prefix, VSCode config, minimalist theme
...
│   └── validations                 # Validation schemas (keep/extend as needed)
...
All unit tests are located alongside the source code in the same directory, making them easier to find. The unit test files follow this format: `*.test.ts` or `*.test.tsx`. The project uses Vitest for unit testing. You can run the tests with the following command:
